...
public class ClasseResourceIntTest {
    ...
    public void createClasse() throws Exception {
        ...
        assertThat(testClasse.getLevel()).isEqualTo(DEFAULT_LEVEL);
        assertThat(testClasse.getWording()).isEqualTo(DEFAULT_WORDING);
        assertThat(testClasse.isActive()).isEqualTo(DEFAULT_ACTIVE);
        assertThat(testClasse.getYear()).isEqualTo(DEFAULT_YEAR);
    }
    ...
    public void updateClasse() throws Exception {
        ...
        Classe testClasse = classeList.get(classeList.size() - 1);
        assertThat(testClasse.getLevel()).isEqualTo(UPDATED_LEVEL);
        assertThat(testClasse.getWording()).isEqualTo(UPDATED_WORDING);
        assertThat(testClasse.isActive()).isEqualTo(UPDATED_ACTIVE);
        assertThat(testClasse.getYear()).isEqualTo(UPDATED_YEAR);
    }
